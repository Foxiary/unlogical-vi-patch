...
1. Tải `unlogical-vi-patch-v1.2.7-romfs.zip` từ trang [Releases](../../releases).
...
<mods>/contents/010068501ff9b002/vn-translation/romfs/    <- DLC 2, title riêng
    scenario/scenario_aoc02
    json/json_aoc02
